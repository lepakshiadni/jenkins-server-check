                ...
                return (
                    <div>
                        <div style={{ width: '450px', marginLeft: '19px', marginTop: "40px" }}>
                            ...
                            <p style={{ fontSize: '16px', fontWeight: '400', color: '#353839' }}>Connect and chat directly with trainers, facilitating clear and efficient
                    ...
                    <div>
                        <div style={{ width: '450px', marginLeft: '19px', marginTop: "40px" }}>
                            ...
                            <p style={{ fontSize: '16px', fontWeight: '400' }}>Sissoo simplifies the way you manage tasks, appointments, and
                                ...
                                well-organized flow.</p>
                            <h1 style={{ fontSize: '24px', fontWeight: '500', color: '#1E1E1E' }}>Smart Networking</h1> */}
                            <p style={{ fontSize: '16px', fontWeight: '400', color: '#353839' }}>Easily find trainers suited to your needs, streamlining the search process. </p>
                            {/* <h1 style={{ fontSize: '24px', fontWeight: '500', color: '#1E1E1E' }}>Effortless Communication</h1> */}
                        </div>
                    </div>
                );
                    ...
                    <div>
                        <div style={{ width: '450px', marginLeft: '19px', marginTop: "40px" }}>
                            ...
                            <p style={{ fontSize: '16px', fontWeight: '400' }}>Sissoo simplifies the way you manage tasks, appointments, and
                                ...
                                well-organized flow.</p>
                            <h1 style={{ fontSize: '24px', fontWeight: '500', color: '#1E1E1E' }}>Smart Networking</h1> */}
                            <p style={{ fontSize: '16px', fontWeight: '400', color: '#353839' }}>By connecting directly with trainers, you can bypass intermediaries, ensuring a

                                direct and seamless experience. </p>
                            {/* <h1 style={{ fontSize: '24px', fontWeight: '500', color: '#1E1E1E' }}>Effortless Communication</h1> */}
                        </div>
                    </div>
                );
