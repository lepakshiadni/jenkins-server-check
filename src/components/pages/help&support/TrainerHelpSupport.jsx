    ...
    <div className="trinersHelp ">
      <div>
        ...
        <div className="flex flex-wrap">
          ...
          >
            ...
            >
              ...
              <div style={{ color: "#2676C2", marginLeft: "14px" }}>
                <h6 style={{ fontSize: "16px", fontWeight: "500" }}>FAQ's </h6>
                <p style={{ fontSize: "12px", fontWeight: "400" }}>
        ...
        <div>
          ...
          >
            <div className="questionMenu" onClick={() => navigate("faq's")}>
              <h6>What Is Sissoo, And How Can It Benefit Me?</h6>

              <ArrowForwardIosIcon />
            </div>
            <hr />
            <div className="questionMenu" onClick={() => navigate("faq's", { state: { selectedOption: 1 } })}>
              <h6>Is Sissoo Available on Android Devices?</h6>
              <ArrowForwardIosIcon />
            </div>
            <hr />
            <div className="questionMenu" onClick={() => navigate("faq's", { state: { selectedOption: 2 } })}>
              <h6>What features does Sissoo Offers to users?</h6>

              <ArrowForwardIosIcon />
            </div>
            <hr />
            <div className="questionMenu" onClick={() => navigate("faq's", { state: { selectedOption: 3 } })}>
              <h6>How Do I Update My Profile Information On Sissoo?</h6>

              <ArrowForwardIosIcon />
            </div>
            <hr />
            <div className="questionMenu" onClick={() => navigate("faq's", { state: { selectedOption: 4} })}>
              <h6>Is My Data Secure On Sissoo?</h6>

              <ArrowForwardIosIcon />
            </div>
            <hr />
            <div className="questionMenu" onClick={() => navigate("faq's", { state: { selectedOption: 5 } })}>
              <h6>What is Proposal option in Proposal Management?</h6>

              <ArrowForwardIosIcon />
            </div>
            <hr />
            <div className="questionMenu" onClick={() => navigate("faq's", { state: { selectedOption: 6 } })}>
              <h6>What are upcoming, Ongoing and Completed training's?</h6>
