...
import TrainingData from "./TrainingData2";
...
import { getAppliedTrainingEmployer,getAllAppliedTraining,employerDetails} from '../../../../redux/action/employers.action'
...
const EmployerDashboardData = () => {
  ...
  const tasks = useMemo(
    () => [
      { title: "Update Profile Picture", completed: employer?.basicInfo?.profileImgStatus },
      { title: "Banner Picture", completed: employer?.basicInfo?.profileBannerStatus },
      { title: "Contact Information", completed: employer?.contactInfo?.status },
      { title: "Training Posted", completed: postDetails?.length > 0 },
    ],
    [employer]
  ); 
  ...
  useEffect(() => {
    ...
    appliedTraining?.getAppliedTraining?.forEach(({ trainingDetails }) => {
      applicationCount += trainingDetails.length;
    });
  
    setApplication(applicationCount);
  }, [appliedTraining]);
  console.log('applicationcout',application)


  const defaultValue1 = postDetails?.length || 0;
  const defaultValue2 = application || 0;
  ...
  // console.log('postedDetails',appliedTraining?.getAppliedTraining?.slice(0,1))
  ...
  if (appliedTraining?.success) {
    ...
    recentProposal = appliedTraining?.getAppliedTraining?.slice(0,1)?.map((details) => {
      return {
          trainerId: details.trainerId,
          trainerProfileImg: details.trainerProfileImg,
          trainerName: details.trainerName,
          ...
          trainerRating: details.trainerRating
        ,
        trainingDetails: details?.trainingDetails?.[0]
      };
    });

  }
  console.log('recentProposal', recentProposal);
  ...
  return (
    <section>
      <section className="dashboardData flex items-center justify-between">
        <div className="dashboardMain">
          ...
          <div className="dashChaild3">
            <Link to="/employerDashboard/trainingmanagement/posted"><h4 className="">Trainings</h4></Link>
            {defaultValue1 > 99 ? (
        ...
        <div className="dashboardMain">
          ...
          <div className="dashChaild3 ">
            <Link to="/employerDashboard/proposalmanagement/proposal"><h4 className=""> Applications</h4></Link>
            {defaultValue2 > 99 ? (
              <h3 className="dashChaild5">
        ...
        <div className="dashboardMain">
          ...
          <div className="dashChaild3">
            <Link to="/employerDashboard/messages"><h4 className="">Messages</h4></Link>
            {defaultValue3 > 99 ? (
              <h3 className="dashChaild5">
      ...
      <section className="flex w-full">
        <div className="flex flex-col w-[73%]">
          <div className="graphMain" style={{ marginTop: "20px" }}>
            <div style={{ padding: "20px" }}>
              ...
              >
                Statistics of {employer?.fullName}
              </h3>
                ...
                <div>
                  ...
                  <div className="graphLabel">
                    <div className="flex items-center">
                      ...
                      ></div>
                      <h3 style={{ fontSize: "16px" }}>More than 30 Posted</h3>
                    </div>
                    <div className="flex items-center mt-7 mb-7">
                      ...
                      ></div>
                      <h3 style={{ fontSize: "16px" }}>20 - 30 Posted</h3>
                    </div>
                    <div className="flex items-center">
                      <div
                        className="graphChild"
                      ...
                      ></div>
                      <h3 style={{ fontSize: "16px" }}>10 - 20 Posted</h3>
                    </div>
                  </div>
                  <button
                    className="mt-10"
              ...
              >
                <CircularProgressbar
                  ...
                  styles={{
                    ...
                    path: {
                      stroke: `${value > 95 ? 'rgba(245, 247, 246)':'rgba(255, 255, 255, 0.6)'}`,
                      strokeWidth: 4,
        ...
        <div className="w-[25%]">
          <TrainingData allTraining={appliedTraining} />
        </div>
      </section>
      <section className="w-full mt-[20px] flex justify-center bg-[#EAF2F9] h-[auto] pb-[20px] items-center flex-col rounded-lg">
        <div className="w-[95%]">
          ...
          <EmployerOngoing onGoing={ongoing?.slice(0,1)} />
        </div>
      </section>
      <section className="mt-4 w-full">
        ...
        >
          ...
          <div className="allaround">
            <EmployerProposalRequest 
            appliedTrainingDetails={recentProposal}
            />
          </div>
        </div>
      </section>
...
export default EmployerDashboardData;
