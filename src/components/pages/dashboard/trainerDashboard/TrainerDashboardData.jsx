...
import { gettrainerAppliedTraining, trainerDetails } from '../../../../redux/action/trainer.action'
...
const TrainerDashboardData = () => {
  ...
  const appliedTraining = useSelector(({ trainerSignUp }) => {
    return trainerSignUp?.gettrainerAppliedTraining
  })
  ...
  const tasks = useMemo(
    () => [
      { title: "Update Profile Picture", completed: trainer?.basicInfo?.profileImgStatus },
      { title: "Banner Picture", completed: trainer?.basicInfo?.profileBannerStatus },
      { title: "Contact Information", completed: trainer?.contactInfo?.status },
  ...
  const defaultValue1 = appliedTraining?.trainingPostData?.length;
    ...
    <section>
      <section className="dashboardData flex items-center justify-between">
        ...
        <div className="dashboardMain">
          ...
          <div className="dashChaild3">
            <Link to=""><h4 className="animate-pulse">Courses</h4></Link>
            <span className=" animate-pulse">Lanching Soon!</span>
            {/* {defaultValue3 > 99 ? (
              <h3 className="dashChaild5">
        ...
        <div className="flex flex-col w-[73%]">
          <div className="graphMain" style={{ marginTop: "20px" }}>
            <div style={{ padding: "20px" }}>
              ...
              >
                Training  Statistics of {trainer?.fullName}
              </h3>
          ...
          <Link to='/trainerprofile/trainerProfileEdit'>
      ...
      <section className="w-full mt-[20px] flex justify-center bg-[#EAF2F9] h-[auto] pb-[20px] items-center flex-col rounded-lg">
        <div className="w-[95%]">
          <div className="w-full mt-[10px] flex justify-between items-center">
            ...
            <Link to="/trainerDashboard/mytrainings/ongoing"><h3 className="textChild" style={{ fontWeight: "500" }}>My Training</h3></Link>
          </div>
      ...
      <section className="mt-4 w-full">
        ...
        >
          <div className="praposalChild flex items-center justify-between">
            ...
            <Link to="/trainerDashboard/proposalmanagement/proposalrequest"><h3 className="textChild">Proposal Management</h3></Link>
          </div>
...
export default TrainerDashboardData;
