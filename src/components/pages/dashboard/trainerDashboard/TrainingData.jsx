...
import '../../../styles/TrainerdashboardData.css'
import Carousel from "react-material-ui-carousel";
import { FaArrowRight, FaArrowLeft } from "react-icons/fa6";
const TrainingData = ({ allTraining }) => {
  console.log('traingData', allTraining)
  let training = [];
  ...
  if (allTraining?.success) {
    ...
    allTraining?.trainingPostData?.forEach(({ appliedStatus, trainingPostDetails, applicationstatus }) => {
      if (appliedStatus) {
